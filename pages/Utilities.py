...
def main():
    def intro():
        ...
        st.divider()
        st.caption("Scraper cita web sajtove i smesta podatke u Pinecone Index")
        st.caption("Positive ubacuje cele dokumente u Pinecone Index")
        st.caption("Dokumenti priprema dokumente i Indexira u Pinecone Index")
        st.caption("Utilities odrzava Pinecone Index")
        st.caption("Stats prikazuje statistiku Pinecone Indexa")
        st.caption("New Login otvara novog korsinika")
        st.caption("Change Login menja ime korisnika")

        st.sidebar.success("Select an Utility from a Drop Box.")
